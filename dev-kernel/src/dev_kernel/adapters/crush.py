...
class CrushAdapter(ToolchainAdapter):
    ...
    def available(self) -> bool:
        ...
        if self._available is None:
            self._available = shutil.which("crush") is not None
    ...
    def _build_command(self, prompt_file: Path, model: str) -> list[str]:
        ...
        # Read prompt from file and pass via --prompt
        # Crush uses --prompt for non-interactive mode
        ...
        # Auto-approve for autonomous mode
